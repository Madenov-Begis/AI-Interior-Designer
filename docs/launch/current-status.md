...
5. Подтвердить операционную безопасность: self-lockout protection, MFA/резервный owner Supabase и минимальные Vertex IAM/quota. Формальные RPO/RTO уже утверждены.
