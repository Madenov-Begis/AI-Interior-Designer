...
- Реквизиты Оператора и Исполнителя заполнены по свидетельству ИП: MADENOV BEGIS SPANTAMANOV ULI, запись в Едином государственном реестре № 7987228 от 4 сентября 2026 года. Публичные маршруты Политики и Оферты, ссылки, явное согласие и серверная фиксация версии согласия подготовлены в коде; `pnpm legal:check` проходит.
