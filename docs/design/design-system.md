...
Пустой проект использует тот же каркас холста и инспектора, что и проект с фотографией. Загрузка показывается компактным действием внутри сетки холста; отдельный крупный экран загрузки не используется. На узком экране инспектор открывается существующим триггером настроек.
