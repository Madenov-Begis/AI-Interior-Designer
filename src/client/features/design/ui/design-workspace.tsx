...
import { CanvasViewport } from "@/client/features/design/ui/canvas-viewport";
import { DesignInspector } from "@/client/features/design/ui/design-inspector";
import { EmptySourceWorkspace } from "@/client/features/design/ui/empty-source-workspace";
import { GenerationCanvasCard } from "@/client/features/design/ui/generation-canvas-card";
import { GenerationContextOverlay } from "@/client/features/design/ui/generation-context-overlay";
import { GenerationRefinementComposer } from "@/client/features/design/ui/generation-refinement-composer";
import { ResultActions } from "@/client/features/design/ui/result-actions";
import { SourceReplaceControl } from "@/client/features/design/ui/source-replace-control";
import { WorkspaceToolbar } from "@/client/features/design/ui/workspace-toolbar";
...
} from "@/client/features/design/ui/workspace-types";
import { nextRefinementOverlayState } from "@/client/features/canvas/model/refinement-overlay-state";
import {
  CREDITS_QUERY_KEY,
  creditQueryOptions,
  loadCredits,
} from "@/client/features/credits/client";
import {
  ApiResponseError,
...
} from "@/client/features/generations/client-wallet";
import { buildGenerationLabels } from "@/client/features/generations/tree";
import { INTERIOR_STYLES } from "@/client/features/generations/interior-styles";
import type {
  VisualPromptEditorHandle,
  VisualPromptTool,
} from "@/client/features/visual-prompt/types";
import { ApiClientError, apiData as axiosApiData } from "@/client/shared/api/client";
