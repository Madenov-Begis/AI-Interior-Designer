...
import type { ValidatedSourceImage } from "@/features/media/image-validation";
...
} from "@/features/media/interior-image-policy";
import { createVertexGenAi } from "@/lib/google/vertex-client";
